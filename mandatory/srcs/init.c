...
/*   Updated: 2024/09/15 18:13:34 by nhayoun          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	mock_data(t_data *data)
{
	...
	data->map[0] = ft_strdup("        ");
	data->map[1] = ft_strdup("        ");
	data->map[2] = ft_strdup("        ");
