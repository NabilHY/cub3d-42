...
/*   Updated: 2024/10/10 19:26:53 by nhayoun          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	another_another_function(char **copy, int *error, int height)
{
	int	i;
...
int	parsing_test(t_data *data)
{
	...
	if (another_another_function(copy, &error, data->h_map) == 1)
